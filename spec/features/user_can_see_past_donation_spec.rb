...
RSpec.feature "user sees past donation" do
  scenario "donation page is shown for authenticated user" do
    ...
    supply1 = create(:supply, name: "Pot-Small", value: 3.0, multiplier_type: "household")
