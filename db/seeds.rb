...
nationality3 = Nationality.create(photo_path: "iraqi_photo.jpeg",
  ...
  "-safety-latest-updates-storify", greeting: "iraqi_greeting.png",
  name: "Iraqi")
nationality4 = Nationality.create(photo_path: "burmese_photo.jpeg",
  ...
  "has-grown-thailand", greeting: "burmese_greeting.png",  name: "Burmese")
...
family3 = Family.create(first_name: "TestFirst", last_name: "TestLast",
  arrival_date: 10.days.from_now, donation_deadline: 5.days.from_now,
  nationality_id: nationality3.id, num_married_adults: 2,
  num_unmarried_adults: 0, num_children_over_two: 1, num_children_under_two: 1,
...
family4 = Family.create(first_name: "TestFirst", last_name: "TestLast",
  arrival_date: 10.days.from_now, donation_deadline: 5.days.from_now,
  nationality_id: nationality4.id, num_married_adults: 0,
  num_unmarried_adults: 1, num_children_over_two: 3, num_children_under_two: 0,
...
family5 = Family.create(first_name: "TestFirst", last_name: "TestLast",
  arrival_date: 10.days.from_now, donation_deadline: 5.days.from_now,
  nationality_id: nationality5.id, num_married_adults: 2,
